...
class GUI:
	...
	def __init__(self):
		...
		self.window.set_title("daxXxter Google Dork Scan V0.1")
		self.window.set_resizable(False)
		color = gdk.color_parse('#444444')
		self.window.modify_bg(STATE_NORMAL, color)

		fix = Fixed()

		self.lb1 = Label("<span color='green'>Search:</span>")
		self.lb2 = Label("<span color='green'>Autor: rio suyanto</span>")
		...
		self.view.set_size_request(470, 150)
		sw = ScrolledWindow()
